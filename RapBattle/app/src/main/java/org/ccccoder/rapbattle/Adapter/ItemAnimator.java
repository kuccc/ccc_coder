...
public class ItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == ItemAdapter.RECORD_VIEW) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((ItemAdapter.RecordViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final ItemAdapter.RecordViewHolder holder) {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            ItemAdapter.RecordViewHolder holder = (ItemAdapter.RecordViewHolder) newHolder;

            animateHeartButton(holder);
            //updateLikesCounter(holder, holder..likesCount);
            if (ItemAdapter.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    public void animateHeartButton(final ItemAdapter.RecordViewHolder holder) {
    ...
    private void updateLikesCounter(ItemAdapter.RecordViewHolder holder, int toValue) {
